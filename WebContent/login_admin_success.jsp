		...
		<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-header header lt">
				<div class="layui-main mag0">
					<a href="#" class="logo" alt="文字标题">欢迎来到飞机售票系统---管理员</a>
					<!-- 显示/隐藏菜单 -->
					...
					<ul class="layui-nav top_menu">
						...
						<li class="layui-nav-item" id="userInfo">
							...
							<dl class="layui-nav-child">
								...
								<dd><a href="javascript:;" data-url="changePassword.jsp"><i class="layui-icon ">&#xe770;</i><cite>修改密码</cite></a></dd>
			...
			<div class=" main_body_content" style="overflow: hidden;">
					...
					<div class="navBar layui-side-scroll" id="navBar">
						<ul class="layui-nav layui-nav-tree">
							<li class="layui-nav-item layui-this">
								<a href="javascript:;" data-url="main_admin.jsp?UserName=<%=UserName%>">
				...
				<div class="layui-tab-content clildFrame">
					<div class="layui-tab-item layui-show">
						...
						<iframe src="main_admin.jsp?UserName=<%=UserName%>" frameborder="0" scrolling="no" id="iframe"></iframe>
					</div>
				</div>
			</div>
