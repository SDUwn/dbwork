...
if(starttime.equals("")){
	...
	while(rs1.next()){
		...
		SQL2="select count(*) from flight_seat where flight_ID='"+flight.flight_id+"' and seat_state='正常' ";
...
while(rs2.next()){
	...
	SQL3="select count(*) from flight_ticket where ticket_ID='"+one.flight_id+"' ";
	...
	SQL3="select count(*) from flight_ticket where ticket_ID='"+two.flight_id+"' ";
